...
export const config_NCL ={
  user: process.env.WDB_USER_NCL ,
    password: process.env.WDB_PASSWORD_NCL,
    server: process.env.WDB_SERVER_NCL,
    database: process.env.WDB_DATABASE_NCL,                                                                                                                                                                       
    connectionTimeout: 10 * 60 * 1000, // 10 minutes  
    options:{
      encrypt: false,
      encoding: 'UTF-8' 
