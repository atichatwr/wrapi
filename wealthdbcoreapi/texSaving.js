...
// doc.save().moveTo(25,y-5).lineTo(25,y+10).stroke();
//         doc.fontSize(6).text(ExecuteDate,28, y);
//         doc.save().moveTo(60,y-5).lineTo(60,y+10).stroke();
//         doc.fontSize(6).text(Fund_Code,62, y);
//         doc.save().moveTo(120,y-5).lineTo(120,y+10).stroke();
//         doc.fontSize(6).text(Amc_Code,122, y);
//         doc.save().moveTo(165,y-5).lineTo(165,y+10).stroke();
//         textWidth = doc.widthOfString(tran_Code);
//         centerAligned = 185 - (textWidth/2)
//         doc.fontSize(6).text(tran_Code,centerAligned, y);
//         doc.save().moveTo(208,y-5).lineTo(208,y+10).stroke();
//         // console.log(Nav_Price)
//         textWidth = doc.widthOfString(Nav_Price.toString());
//         rightAlignedX = 233 - textWidth
//         doc.fontSize(6).text(Nav_Price.toString(),rightAlignedX, y);
//         doc.save().moveTo(236,y-5).lineTo(236,y+10).stroke();
//         textWidth = doc.widthOfString(Amount_Unit.toString());
//         rightAlignedX = 277 - textWidth
//         doc.fontSize(6).text(Amount_Unit.toString(),rightAlignedX, y);
//         doc.save().moveTo(280,y-5).lineTo(280,y+10).stroke();
//         textWidth = doc.widthOfString(Amount_Baht.toString());
//         rightAlignedX = 330 - textWidth
//         doc.fontSize(6).text(Amount_Baht.toString(),rightAlignedX, y);
//         doc.save().moveTo(333,y-5).lineTo(333,y+10).stroke();
//         textWidth = doc.widthOfString(Amount_Unit.toString());
//         rightAlignedX = 370 - textWidth
//         doc.fontSize(6).text(Amount_Unit.toString(),rightAlignedX, y);
//         doc.save().moveTo(377,y-5).lineTo(377,y+10).stroke();
...
//     doc.text(table[0][0], 35, y+2);     // วันที่
//     doc.save().moveTo(65,y).lineTo(65,y+30).stroke();
//     doc.text(table[0][1], 80, y+2); // กองทุน
//     doc.save().moveTo(135,y).lineTo(135,y+30).stroke();
//     doc.text(table[0][2], 122, y+2);   // บริษัทจัดการ
//     doc.save().moveTo(165,y).lineTo(165,y+30).stroke();
//     doc.text(table[0][3], 170, y+2);    // รายการ
//     doc.save().moveTo(208,y).lineTo(208,y+30).stroke();
//     doc.text(table[0][4], 214, y+2);    //ราคา
//     doc.save().moveTo(236,y).lineTo(236,y+30).stroke();
//     doc.text(table[0][5], 238, y+2);    // จำนวนหน่วย
//     doc.save().moveTo(280,y).lineTo(280,y+30).stroke();
//     doc.text(table[0][6], 287, y+2);  // จำนวนเงินซื้อ่
//     doc.save().moveTo(333,y).lineTo(333,y+30).stroke();
//     doc.text(table[0][7], 338, y+2);   //จำนวนเงินขาย
//     doc.save().moveTo(383,y).lineTo(383,y+30).stroke();
//     doc.text(table[0][8], 465, y+2);     //ต้นทุน
//     doc.text(table[0][9], 510, y+2);     // กำไรขาดทุน
//     doc.text(table[0][10], 560, y+12);     // %
//     doc.save().moveTo(563,y).lineTo(563,y+30).stroke();

// doc.text(table[1][0], 35, y-2);    //Date
//     doc.text(table[1][1], 80, y-2);  // Fund
//     doc.text(table[1][2], 122, y-2);    // AMC
//     doc.text(table[1][3], 170, y-2);    // Tran Type
//     doc.text(table[1][4], 214, y-2);    // Price
//     doc.text(table[1][5], 248, y-2);    //Units
//     doc.text(table[1][6], 287, y-2);     //Buy Amount
//     doc.text(table[1][7], 338, y-2);     //Sell Amount
//     doc.text(table[1][8], 465, y-2);     //Cost
//     doc.text(table[1][9], 510, y-2);     //Gain (Loss)
