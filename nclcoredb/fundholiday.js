...
async function selectDataHoliday(callback){
    try{
        ...
        let statement =`SELECT dbo.MFTS_Fund.Fund_Id,dbo.Fund_Cen_Fund_Holiday_Date.* 
                        ...
                        WHERE timestampx >= '${datenow}' AND dbo.MFTS_Fund.Fund_Id Between 1 and 500
                        ORDER BY Fund_Id `
...
async function checkDataHoliday(datarows){
    ...
    console.log("==========================  End Process Time :" + console_time)
    
}

async function importDataHoliday(datas){ 
    // console.log(datas) 
...
export {selectDataHoliday,checkDataHoliday, importDataHoliday, selectDataTrandCalendar ,selectREFHoliday}